...
Fern is **fully compatible with OpenAPI.** You can use your existing OpenAPI speification to generate code and documentation with Fern. If you're not a fan of OpenAPI, you can also use Fern's [simpler format](/definitiondefinition.mdx) to define your API.
