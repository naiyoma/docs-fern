...
[fern check](/docs/cli/fern-generate): Validate your API definitions and Fern configuration.
[fern add](/docs/cli/fern-add): Incorporate a new generator to your Fern configuration.
