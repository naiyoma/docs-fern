...
The navigation organizes your documentation in the nav bar. Each section has a title and a list of contents. Contents contain a page name and a file path. The supported file types are `.mdx` or `.mdxx`.
