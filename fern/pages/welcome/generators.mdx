...
| Language | Availability | Package Manager | fern add <generator>
| -------- | -------- | -------- | -------- |
| [TypeScript](../sdks/node-sdk)  | Generally available | NPM  | `fern add fernapi/fern-typescript-node-sdk`
| [Python](../sdks/python-sdk)  | Generally available  | PyPI  |
| [Go](../sdks/go-sdk)  | Generally available  | Proxy Module  |
| [Java](../sdks/java-sdk)  | Generally available  | Maven  |
| [C#](../sdks/csharp-sdk)  | In development  | NuGet  |
| [Ruby](../sdks/ruby-sdk)  | Coming by end of year | Gems  |
| [PHP](../sdks/php-sdk)  | Coming next year | Packagist  |
...
| Framework | Language | Availability |
| -------- | -------- | -------- |
| [Express](../server-boilerplate/express)  | JavaScript | Generally available  |
| [FastAPI](../server-boilerplate/fastapi)  | Python  | Generally available  |
| [Spring](../server-boilerplate/spring)  | Java  | Generally available  |
| [Go](../server-boilerplate/go)  | Go | Coming next year  |
| [.NET](../server-boilerplate/dotnet)  | C#  | Coming next year  |
| [Ruby on Rails](../server-boilerplate/ruby-on-rails)  | Ruby | Coming next year  |
| [Laravel](../server-boilerplate/laravel)  | PHP | Coming next year  |
| [Django](../server-boilerplate/django)  | Python | Coming next year  |
| [Flask](../server-boilerplate/flask)  | Python | Coming next year  |
